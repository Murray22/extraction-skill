...
sp='../data/derived'
out=[]
for f in sorted(glob.glob('/home/steve_murray/projects/GameVibe/beta-sports/basketball/wbb/data_raw/gated_seasons/wbb_raw_20*_lossless.parquet')):
...
allps.to_parquet(f'{sp}/wbb_pdae_playerseasons.parquet')
